...
class MyBall():
    ...
    def Stamp(self):
        ...
        self.drawobj = canvas.create_line(self.x[0] - self.jig2, self.y[0] - self.jig, self.x[1] + self.jig2, self.y[1] + self.jig, fill = self.color, width= self.linewidth)
        self.switcharoo = randint(0, 2)
        if self.switcharoo == 0:
            self.drawobj2 = canvas.create_rectangle(self.x[0] - self.jig2, self.y[1] + self.jig, self.x[1] + self.jig2, self.y[0] -  self.jig, outline = self.color, width = self.linewidth2)
        elif self.switcharoo == 1:
            self.drawobj2 = canvas.create_line(self.x[0] - self.jig2, self.y[1] + self.jig, self.x[1] + self.jig2, self.y[0] -  self.jig, fill = self.color, width = self.linewidth2)
        elif self.switcharoo == 2:
            self.drawobj2 = canvas.create_oval(self.x[0] - self.jig2, self.y[1] + self.jig, self.x[1] + self.jig2, self.y[0] -  self.jig, outline = self.color, width = self.linewidth2)
